...
BCF[0].update(dict([((0, 1 + i), ["state.zn", i, "th", (2.0 * 3.14159, 0.0)]) for i in xrange(8)]))
...
BCF[1].update(dict([((0, 1 + i), ["state.zn", 8 + i, "th", (2.0 * 3.14159, 0.0)]) for i in xrange(8)]))

BCF.append(dict([((0, 81 + i), ["state.par", i,      "val", (1.0, 0.0)]) for i in xrange(8)]))
BCF.append(dict([((0, 81 + i), ["state.par", i + 8,  "val", (1.0, 0.0)]) for i in xrange(8)]))
BCF.append(dict([((0, 81 + i), ["state.par", i + 16, "val", (1.0, 0.0)]) for i in xrange(8)]))
BCF.append(dict([((0, 81 + i), ["state.par", i + 24, "val", (1.0, 0.0)]) for i in xrange(8)]))
BCF.append(dict([((0, 81 + i), ["state.par", i + 32, "val", (1.0, 0.0)]) for i in xrange(8)]))
