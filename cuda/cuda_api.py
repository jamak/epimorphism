...
CUDART = "/usr/local/cuda/lib/libcudart.so"
cudart = CDLL(CUDART)
...
cudaMalloc3DArray.argtypes = [ POINTER(cudaArray_p),
    cudaChannelFormatDesc_p, cudaExtent ]
...
cudaGetTextureReference.argtypes = [ POINTER(textureReference_p), c_char_p ]
...
cudaCreateChannelDesc.argtypes = [ c_int, c_int, c_int, c_int, c_uint]
