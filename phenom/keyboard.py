    ...
    def keyboard(self, key, x, y):
        ...
        if(modifiers & GLUT_ACTIVE_CTRL == GLUT_ACTIVE_CTRL):
            if(ord(key) in [49, 0, 27, 28, 28, 30, 31, 127, 57, 48, 1, 19, 4, 6, 7, 8, 10, 11, 12, 59]):
                ...
                self.animator.animate_var("par" + str(i), lambda x: self.cmdcenter.par_setter(i, x), "linear_1d", 400, {"s":x0, "e":x1, 'loop':False})
        ...
        if(key == "\033"):
            ...
            self.animator.animate_var("zn" + str(i), lambda z: self.cmdcenter.zn_setter(i, z), "radial_2d", 200, {"s":z0, "e":z1, 'loop':False})
