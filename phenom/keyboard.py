...
#             # set pars if CTRL
        ...
        def keyboard_async():
            ...
            # toggle fps
                ...
                self.cmdcenter.moduleCmd('bm2009', 'path0', {})

            elif(key == "w"):
                self.cmdcenter.moduleCmd('bm2009', 'path1', {})

            elif(key == "e"):
                self.cmdcenter.moduleCmd('bm2009', 'path2', {})

            elif(key == "r"):
                self.cmdcenter.moduleCmd('bm2009', 'path3', {})

            elif(key == "t"):
                self.cmdcenter.moduleCmd('bm2009', 'path4', {})

            elif(key == "y"):
                self.cmdcenter.moduleCmd('bm2009', 'path5', {})

            elif(key == "u"):
                self.cmdcenter.moduleCmd('bm2009', 'path6', {})

            elif(key == "i"):
                self.cmdcenter.moduleCmd('bm2009', 'path7', {})

            elif(key == "a"):
                self.cmdcenter.moduleCmd('bm2009', 'path8', {})

            elif(key == "s"):
                self.cmdcenter.moduleCmd('bm2009', 'path9', {})

            elif(key == "d"):
                self.cmdcenter.moduleCmd('bm2009', 'path10', {})

            elif(key == "f"):
                self.cmdcenter.moduleCmd('bm2009', 'path11', {})

            elif(key == "g"):
                self.cmdcenter.moduleCmd('bm2009', 'path12', {})

            elif(key == "h"):
                self.cmdcenter.moduleCmd('bm2009', 'path13', {})

            elif(key == "j"):
                self.cmdcenter.moduleCmd('bm2009', 'path14', {})

            elif(key == "k"):
                self.cmdcenter.moduleCmd('bm2009', 'path15', {})
